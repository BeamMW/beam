...
function(generate_sid_header shader_target)
    add_custom_target(${shader_target}_header
        ALL
        COMMAND ${BEAM_PROJECT_BINARY_DIR}/beam/bvm/sid_generator/${BEAM_SIDGEN_BUILD_TYPE}/generate-sid $<TARGET_FILE:${shader_target}> > $<TARGET_PROPERTY:${shader_target},SOURCE_DIR>/contract_sid.i
