...
namespace beam
{
    ...
    public:
        ...
        TxID transfer_money(const WalletID& from, const WalletID& to, const AmountList& amountList, Amount fee = 0, bool sender = true, ByteBuffer&& message = {});
        TxID split_coins(const WalletID& from, const AmountList& amountList, Amount fee = 0, bool sender = true, ByteBuffer&& message = {});
