...
if (NOT TARGET sid_generator)
    add_custom_target(sid_generator ALL
        COMMAND ${CMAKE_COMMAND} 
                                    ...
                                    -S ${BEAM_PROJECT_SOURCE_DIR}
                                    -B ${BEAM_PROJECT_BINARY_DIR}/beam
        COMMAND ${CMAKE_COMMAND} --build ${BEAM_PROJECT_BINARY_DIR}/beam --parallel --target generate-sid --config ${BEAM_SIDGEN_BUILD_TYPE}
...
function(generate_sid_header shader_target)
    add_custom_target(${shader_target}_header
        ALL
        COMMAND ${BEAM_PROJECT_BINARY_DIR}/beam/bvm/sid_generator/${BEAM_SIDGEN_BUILD_TYPE}/generate-sid $<TARGET_FILE:${shader_target}> > $<TARGET_PROPERTY:${shader_target},SOURCE_DIR>/${shader_target}_sid.i
