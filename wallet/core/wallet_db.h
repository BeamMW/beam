    ...
    namespace storage
    {
        ...
        struct Totals
        {
            struct AssetTotals {
                ...
                AmountBig::Number Avail = 0U;
                AmountBig::Number Maturing = 0U;
                AmountBig::Number Incoming = 0U;
                AmountBig::Number ReceivingIncoming = 0U;
                AmountBig::Number ReceivingChange = 0U;
                AmountBig::Number Unavail = 0U;
                AmountBig::Number Outgoing = 0U;
                AmountBig::Number AvailCoinbase = 0U;
                AmountBig::Number Coinbase = 0U;
                AmountBig::Number AvailFee = 0U;
                AmountBig::Number Fee = 0U;
                AmountBig::Number Unspent = 0U;
                AmountBig::Number AvailShielded = 0U;
                AmountBig::Number UnspentShielded = 0U;
                AmountBig::Number MaturingShielded = 0U;
                AmountBig::Number UnavailShielded = 0U;
                AmountBig::Number OutgoingShielded = 0U;
                AmountBig::Number IncomingShielded = 0U;
