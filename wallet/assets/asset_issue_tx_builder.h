...
namespace beam::wallet
{
    ...
    {
    public:
        AssetIssueTxBuilder(BaseTransaction& tx, SubTxID subTxID, const AmountList& amount, Amount fee, beam::AssetID assetId, ECC::Scalar::Native skAsset);

        void SelectInputs();
        void AddChange();
        void GenerateChangeCoin(Amount amount);
        void GenerateAssetCoin(Amount amount, beam::AssetID assetId);
        bool CreateOutputs();
