...
int main()
{
    ...
    auto wdbFirst = createSqliteWalletDB("laser_test_auto_close_first.db", false, false);
    auto wdbSecond = createSqliteWalletDB("laser_test_auto_close_second.db", false, false);
