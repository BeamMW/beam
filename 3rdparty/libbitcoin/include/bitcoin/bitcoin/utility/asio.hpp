...
typedef boost::asio::executor_work_guard<boost::asio::io_context::executor_type> work;
...
typedef boost::asio::ip::basic_resolver_query<tcp> query;
typedef tcp::resolver::results_type iterator;
...
BC_CONSTEXPR int max_connections = boost::asio::socket_base::max_listen_connections;
