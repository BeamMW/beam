...
#include "../bitcoin/bitcoin_electrum.h"
#include "options.h"

namespace beam
{
    class LitecoinElectrum : public BitcoinElectrum
    {
    public:
        LitecoinElectrum() = delete;
        LitecoinElectrum(io::Reactor& reactor, const LitecoinOptions& options);
