...
int main()
{
    ...
    auto testAll = [&](Amount fee) {
        ...
        auto newBlockFunc = [&](Height height)
        {
            ...
            {
                BEAM_LOG_ERROR() << "Test laser CLOSE: time expired";
                WALLET_CHECK(false);
