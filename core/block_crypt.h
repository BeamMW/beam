...
namespace beam
{
	...
	struct Block
	{
		...
		struct PoW
		{
			...
			bool IsValid(const void* pInput, uint32_t nSizeInput, uint32_t blockHeight) const;
			...
			bool Solve(const void* pInput, uint32_t nSizeInput, uint32_t blockHeight, const Cancel& = [](bool) { return false; });
