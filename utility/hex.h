...
namespace beam
{
    ...
    std::vector<uint8_t> from_hex_string(const std::string& str, bool* wholeStringIsNumber = nullptr);
    std::vector<uint8_t> from_hex(const std::string_view str, bool* wholeStringIsNumber=nullptr);
